...
class VideoServiceBase {
  ...
  getEmbedCode(videoID, autoplay) {
    ...
    iframeAttributeList.push([ "src", this.getFilteredVideoUrl(videoID, autoplay) ]);
    ...
    // if (autoplay) {
    //   iframeAttributeList.push([ "allow", "autoplay;" ]);
    // }
